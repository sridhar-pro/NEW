...
const data = [
  {
    ...
    content: 'WEBOIN TECHNOLOGIES is the one of fastest growing digital marketing Companies',
...
const FeedItem = React.memo (({ username, place, imageUri, content, hashTag, postedTime }) => {
  ...
  return(
    ...
    <Animated.View style={[styles.feedItem, { opacity: fadeAnim }]}>
        ...
        <View style={[styles.profileImage, styles.profileImageWithBorder]}>
  ...
  <View style={styles.userInfoText}>
    ...
    />
      ...
      <TouchableOpacity onPress={() => handleButtonPress('Comment')}style={styles.button}>
      <Text  style={styles.buttonTextTransparent}>Comment</Text>
      <Image  
        source={require('./profile/com.png')} 
        style={styles.logo}
        resizeMode="contain" 
      />
      </TouchableOpacity>
